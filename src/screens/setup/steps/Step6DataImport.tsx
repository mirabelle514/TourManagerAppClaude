        ...
        <ScrollView style={CommonStyles.container}>
            <View style={CommonStyles.content}>
                <View style={CommonStyles.header}>
                    <Ionicons name="cloud-upload" size={64} color={Colors.accent.primary.main} />
                ...
                <TouchableOpacity style={CommonStyles.importOption}>
                    <Ionicons name="logo-google" size={32} color={Colors.accent.primary.main} />
                ...
                <TouchableOpacity style={CommonStyles.importOption}>
                    <Ionicons name="document-text" size={32} color={Colors.accent.primary.main} />
                    <View style={CommonStyles.optionContent}>
